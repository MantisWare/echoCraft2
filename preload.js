...
const BYOK_KEY_BRIDGES = [
  ...
  { base: "huggingface", get: "getHuggingfaceKey", save: "saveHuggingfaceKey" },
...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  copyLastTranscription: () => ipcRenderer.invoke("copy-last-transcription"),
  ...
  onShowHistory: registerListener("show-history", (callback) => () => callback()),
  ...
  // Calendar providers this build has OAuth credentials for
  getCalendarProviderAvailability: () => ipcRenderer.invoke("calendar-get-provider-availability"),
