#!/usr/bin/env node
// Compiles src/assets/echocraft.icon (Apple Icon Composer bundle) into
...
const ICON_BUNDLE = path.join(__dirname, "..", "src", "assets", "echocraft.icon");
const OUTPUT_CAR = path.join(__dirname, "..", "src", "assets", "Assets.car");
// Must match CFBundleIconName in electron-builder.json, or macOS 26 falls back
// to the legacy .icns.
const APP_ICON_NAME = "echocraft";
