...
function useSettingsInternal() {
  ...
  return {
    ...
    huggingfaceApiKey: store.huggingfaceApiKey,
    ...
    meetingDetectionIgnoredApps: store.meetingDetectionIgnoredApps,
    setMeetingDetectionIgnoredApps: store.setMeetingDetectionIgnoredApps,
