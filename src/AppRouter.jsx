...
import { ACCOUNT_UI_ENABLED } from "./config/accountFeatures.ts";
...
function MainApp() {
  ...
  useEffect(() => {
    ...
    if (isControlPanel) {
      ...
      } else if (ACCOUNT_UI_ENABLED && !isSignedIn && !authSkipped) {
        setNeedsReauth(true);
      }
    }
    ...
    <div className="min-h-screen bg-background flex items-center justify-center">
      <div className="flex flex-col items-center gap-4 animate-[scale-in_300ms_ease-out]">
        <img
          ...
          decoding="async"
          draggable={false}
          className="w-12 h-12 drop-shadow-[0_2px_8px_rgba(59,130,246,0.18)] dark:drop-shadow-[0_2px_12px_rgba(139,92,246,0.25)]"
        />
