...
declare global {
  interface Window {
    electronAPI: {
      ...
      copyLastTranscription?: () => Promise<{ success: boolean; copied: boolean }>;
      ...
      getHuggingfaceKey: () => Promise<string | null>;
      saveHuggingfaceKey: (key: string) => Promise<void>;
      ...
      getCalendarProviderAvailability?: () => Promise<CalendarProviderAvailability>;
