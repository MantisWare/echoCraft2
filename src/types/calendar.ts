...
/**
 * Whether this build can offer each calendar provider. Google and Microsoft
 * depend on build-time OAuth client credentials; Apple depends on the platform.
 * Resolved in the main process by `calendarProviderAvailability.js`.
 */
export type CalendarProviderAvailability = Record<CalendarProviderId, boolean>;
