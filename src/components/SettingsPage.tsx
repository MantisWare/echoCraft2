...
export default function SettingsPage({
  ...
  const renderSectionContent = () => {
    switch (activeSection) {
      case "account":
        if (!ACCOUNT_UI_ENABLED) return null;
        return (
                      ...
                      steps: [
                        ...
                        },
                        {
                          ...
                          desc: t("settingsPage.general.waylandPaste.guide.group.step2Desc", {
                            defaultValue:
                              "Group changes only take effect after a new login session. Log out of your desktop and log back in, then reopen EchoCraft.",
                          }),
                        },
                      ],
                    },
