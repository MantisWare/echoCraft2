...
function resolveModeDisplayProvider(mode, provider) {
  ...
  // Only the provider-backed modes name a provider. Anything else (including a
  // retired mode left in storage) reports none rather than surfacing a stale id.
  if (mode !== "providers" && mode !== "enterprise") return "none";
