...
// 8200-8219 belongs to OpenWhispr's bridge; staying clear of it lets both apps
// run at once without racing for a port or overwriting each other's token file.
// Also clear of llamaServer (8221-8240) and whisperServer (8178-8199).
const PORT_RANGE_START = 8260;
const PORT_RANGE_END = 8279;
...
function getBridgeFilePath() {
  return path.join(os.homedir(), ".echocraft", "cli-bridge.json");
}
