...
const DBUS_SERVICE_NAME = "com.mantisware.EchoCraft";
const DBUS_OBJECT_PATH = "/com/mantisware/EchoCraft";
const DBUS_INTERFACE = "com.mantisware.EchoCraft";

// Per-slot gsettings paths and display names
const SLOT_CONFIG = {
  dictation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/echocraft/",
    name: "EchoCraft Toggle",
  },
  meeting: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/echocraft-meeting/",
    name: "EchoCraft Meeting",
  },
  voiceAgent: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/echocraft-voice-agent/",
    name: "EchoCraft Voice Assistant",
  },
  translation: {
    path: "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/echocraft-translation/",
    name: "EchoCraft Translation",
  },
};
...
class GnomeShortcutManager {
  ...
  removeRetiredAgentKeybinding() {
    const retiredPath =
      "/org/gnome/settings-daemon/plugins/media-keys/custom-keybindings/echocraft-agent/";
    try {
