...
class TrayManager {
  constructor() {
    ...
    this.copyLastTranscription = null;
  ...
  setCopyLastTranscription(callback) {
    this.copyLastTranscription = callback;
  }
  ...
  buildContextMenuTemplate() {
    ...
    return [
      ...
      { type: "separator" },
      {
        label: i18nMain.t("tray.openHistory"),
        click: () => {
          void this.windowManager?.openHistory?.();
        },
      },
      {
        label: i18nMain.t("tray.copyLastTranscription"),
        click: () => {
          void this.copyLastTranscription?.();
        },
      },
      { type: "separator" },
      {
